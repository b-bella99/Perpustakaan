	...
	<div class="main-container">
		<div class="customscroll customscroll-10-p height-100-p xs-pd-20-10 pd-ltr-20">
			...
			<div class="row" align="center">
				<div class="col-4" style="background-color: #F4D7F7; padding-top: 30; padding-bottom: 30; margin-left: 17">
					<img src="<?php echo base_url();?>assets/admin/src/images/book.png">
					<h3><b>Buku</b></h3>
					<br><p>Budayakan membaca buku</p>
				</div>
				<div class="col-3" style="background-color: #EBF7DF; padding-top: 30; padding-bottom: 30; margin-left: 35">
					<img src="<?php echo base_url();?>assets/admin/src/images/waktu.png">
					<h3><b>Hemat waktu</b></h3>
					<br><p>hemat waktu</p>
				</div>
				<div class="col-4" style="background-color: #D7EEF7; padding-top: 30; padding-bottom: 30; margin-left: 35">
					<img src="<?php echo base_url();?>assets/admin/src/images/shopify.png">
					<h3><b>Nyaman</b></h3>
					<br><p>Platform yang sangat nyaman</p>
				</div>
			</div>
