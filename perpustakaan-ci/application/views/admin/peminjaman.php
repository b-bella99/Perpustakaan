			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h5 class="text-blue">Data Peminjaman</h5><br>
							<?php if ($this->session->flashdata('flash-data')): ?>
						        <div class="row mt-12">
						            <div class="col-md-12">
						                <div class="alert alert-success alert-dismissible fade show" role="alert">
						                Data Peminjaman <strong> berhasil </strong> <?= $this->session->flashdata('flash-data'); ?>
						    ...
						    <?php endif; ?>
						<!--	<p class="font-14"> <a class="btn btn-primary" href="<?php echo base_url();?>index.php/admin/tambahproduk">Tambah Data Baru</a></p> -->
						</div>
					</div>
					<div class="row">
						<table class="table table-striped table-bordered" id="peminjaman">
							<thead>
								<tr>
									<!-- stuck disini tar tanya mbak bel2 -->
									<th>Kode</th>
					                        ...
					                        <td>
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a class="dropdown-item" disabled href="<?= base_url();?>admin/detailpeminjaman/<?= $p['kode'];?>"><i class="fa fa-eye"></i> Detail</a>
